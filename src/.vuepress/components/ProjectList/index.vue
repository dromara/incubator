    ...
    <div class="card" v-for="project in dataList" :key="project.name">
      ...
      <div class="icons">
        <div class="icons-container">
          <a class="github" :href="`https://github.com/dromara/${project.name}`" target="_blank">
          ...
          <a class="gitee" :href="`https://gitee.com/dromara/${project.name}`" target="_blank">
