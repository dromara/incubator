import{g as S,D as h,E as m,P as r,_ as A,r as k,o as C,Y as D,F as u,Z as v,a0 as t,J as s,H as p,Q as a,I as j,f as g}from"./chunks/framework.lDRhkpKe.js";import{N as _,a as I,b as f,c,d as E,e as w,f as L,g as N}from"./chunks/theme.COOiLHpE.js";const q={xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 512 512"},O=r("path",{d:"M256 32C132.3 32 32 134.9 32 261.7c0 101.5 64.2 187.5 153.2 217.9a17.56 17.56 0 0 0 3.8.4c8.3 0 11.5-6.1 11.5-11.4c0-5.5-.2-19.9-.3-39.1a102.4 102.4 0 0 1-22.6 2.7c-43.1 0-52.9-33.5-52.9-33.5c-10.2-26.5-24.9-33.6-24.9-33.6c-19.5-13.7-.1-14.1 1.4-14.1h.1c22.5 2 34.3 23.8 34.3 23.8c11.2 19.6 26.2 25.1 39.6 25.1a63 63 0 0 0 25.6-6c2-14.8 7.8-24.9 14.2-30.7c-49.7-5.8-102-25.5-102-113.5c0-25.1 8.7-45.6 23-61.6c-2.3-5.8-10-29.2 2.2-60.8a18.64 18.64 0 0 1 5-.5c8.1 0 26.4 3.1 56.6 24.1a208.21 208.21 0 0 1 112.2 0c30.2-21 48.5-24.1 56.6-24.1a18.64 18.64 0 0 1 5 .5c12.2 31.6 4.5 55 2.2 60.8c14.3 16.1 23 36.6 23 61.6c0 88.2-52.4 107.6-102.3 113.3c8 7.1 15.2 21.1 15.2 42.5c0 30.7-.3 55.5-.3 63c0 5.4 3.1 11.5 11.4 11.5a19.35 19.35 0 0 0 4-.4C415.9 449.2 480 363.1 480 261.7C480 134.9 379.7 32 256 32z",fill:"currentColor"},null,-1),R=[O],x=S({name:"LogoGithub",render:function(y,d){return h(),m("svg",q,R)}}),e={POPULAR_TOOLS:"流行工具",IMAGE_COMBINER_DESC:"Java服务端图片合成工具",WEMQ_DESC:"WeMQ是一款面向物联网设备运营商的开源物联网设备调试系统，提供集成设备管理、MQTT服务器管理、客户管理等功能，自研Nmqs通信层组件，实现了连接信息的加密，保证了数据的安全性。",ELECTRON_EGG_DESC:"一个入门简单、跨平台、企业级桌面软件开发框架",EASY_TRANS_DESC:"一个注解搞定数据翻译,减少30%SQL代码量",FAST_REQUEST_DESC:"基于jetbrains intellij idea的postman插件",REDISFRONT_DESC:"一款开源跨平台Redis 桌面客户端工具",X_EASYPDF_DESC:"一个用搭积木的方式构建pdf的框架（基于pdfbox）",GOBRS_ASYNC_DESC:"一款功能强大、配置灵活、带有全链路异常回调、内存优化、异常状态管理于一身的高性能异步编排框架",DYJAVA:"DyJava是一款功能强大的抖音Java开发工具包（SDK），支持抖音各个应用OpenAPI快速调用，包括但不限于移动/网站应用、抖音开放平台、抖店和抖音小程序等",ORION_VISOR:"一款高颜值、现代化的智能运维&轻量堡垒机平台。",WARM_FLOW:"国产工作流引擎,其特点简洁轻量但又不简单，五脏俱全，组件独立，可扩展，可满足中小项目的组件.解决flowable和activities复杂、学习成本高和集成难等痛点。",DBSWITCH:"异构数据库迁移同步(搬家)工具",SKYEYE_OA:"智能制造一体化，采用Springboot + winUI的低代码平台开发模式",EASYAI:"国内人气最高的Java人工智能算法框架(java版pytorch)。它可以Maven一键丝滑引入我们的Java项目，无需任何额外的环境配置与依赖，做到开箱即用",MYBATIS_PLUS_EXT:"mybatis-plus框架的拓展包，在框架原有基础上做了进一步的轻度封装，增强内容：免手写Mapper、多数据源自动建表、数据自动填充、自动关联查询、冗余数据自动更新、动态查询条件等。",EASY_QUERY:"一款java下面支持强类型、轻量级、高性能的ORM",TIANAI_CAPTCHA:"可能是java界最好的开源行为验证码, [滑块验证码、点选验证码、行为验证码、旋转验证码，滑动验证码]",DAX_PAY:"DaxPay是一款免费开源的支付系统，支持支付宝、微信、云闪付等通道",MYFLY_GO:"web 版 linux(终端[终端回放] 文件 脚本 进程 计划任务)、数据库（mysql postgres oracle sqlserver 达梦 高斯 sqlite）、redis(单机 哨兵 集群)、mongo 等集工单流程审批于一体的统一管理操作平台",MILVUSPLUS:"使用MyBatisPlus的方式，优雅的操作向量数据库 Milvus，同时支持spring和solon",NEWCAR:"基于CanvasKit-WASM的现代化动画引擎",UJCMS:"支持无头CMS，支持自定义字段及字段可视化设计。可免费用于商业网站",BINLOG4J_DESC:"基于 Java 轻量级的 Mysql Binlog 客户端。",SMS4J_DESC:"SMS4J为短信聚合框架，帮您轻松集成多家短信服务。",STREAM_QUERY_DESC:"允许完全摆脱Mapper的mybatis-plus体验！",PAYMENT_SPRING_BOOT_DESC:"最全最好用的微信支付V3 Spring Boot 组件。",NEUTRINO_PROXY_DESC:"一个基于netty的、开源的java内网穿透项目。",TESTHUB_DESC:"TestHub 是一款基于流程编排的自动化测试工具。",DOMAIN_ADMIN_DESC:"域名SSL证书监测平台、SSL证书申请自动续签。",YFT_DESIGN_DESC:"基于Canvas的开源版“创客贴”。",ZYPLAYER_DOC_DESC:"一款适合团队和个人私有化部署使用的知识库、笔记、WIKI文档管理工具。",X_FILE_STORAGE_DESC:"一站式文件存储，聚合对接所有主流存储平台。",OPERATIONS_AND_MAINTENANCE_CONTROL:"运维管控",BIG_DATA:"大数据",CLOUDEON_DESC:"一款基于kubernetes的云原生大数据平台，致力于简化k8s上大数据集群的运维管理。",DATA_COMPARE_DESC:"数据库比对工具: hive 表数据比对，mysql、Doris 数据比对。",MICROSERVICE:"微服务",LAMP_CLOUD_DESC:"专注于多租户(SaaS架构)解决方案的微服务中后台快速开发平台",DANTE_CLOUD_DESC:"基于 Spring Authorization Server 全新适配 OAuth 2.1 协议的企业级微服务架构",OPEN_CAPACITY_PLATFORM_DESC:"基于Spring Cloud的企业级微服务框架",RUOYI_VUE_PLUS_DESC:"后台管理系统 重写RuoYi-Vue所有功能 集成 Sa-Token+Mybatis-Plus+Jackson+Xxl-Job+SpringDoc+Hutool+OSS",J2EEFAST_DESC:"J2eeFAST 是一个 Java EE 企业级快速开发平台。",DISTRIBUTED_SCHEDULING:"分布式调度",HODOR_DESC:"分布式调度框架",DISJOB_DESC:"一个分布式的任务调度框架。",CARBON_DESC:"一个轻量级、语义化、对开发者友好的 golang 时间处理库"},T=[{name:e.POPULAR_TOOLS,projects:[{name:"mica-mqtt",website:"https://iot.bladex.cn",description:"java mqtt 基于 java aio 实现，开源、简单、易用、低延迟、高性能百万级 java mqtt client 组件和 java mqtt broker 服务",sponsor:"dreamlu",date:"2021.03",link:`
...
`},{name:"dongle",website:"https://pkg.go.dev/gitee.com/dromara/dongle",description:"轻量级、语义化、对开发者友好的 golang 编码解码、加密解密和签名验签库",sponsor:"gouguoyin",date:"2021.03",link:`
...
`},{name:"electron-egg",website:"https://www.yuque.com/u34495/mivcfg",description:e.ELECTRON_EGG_DESC,sponsor:"哆啦好梦（wallace530）",date:"2022.12",link:`
  ...
  <a href="https%3A%2F%2Fwww.oscs1024.com%2Fproject%2Fdromara%2Ffast-request%3Fref%3Dbadge_small"><img onerror="this.style.display='none'" src="https://www.oscs1024.com/platform/badge/dromara/fast-request.svg?size=small" alt="OSCS Status"></a>`},{name:"redisfront",website:"https://www.redisfront.com/",description:e.REDISFRONT_DESC,sponsor:"westboy",date:"2022.12",link:`<img onerror="this.style.display='none'" src="https://img.shields.io/badge/JDK-17-blue.svg" alt="JDK">
  <img onerror="this.style.display='none'" src="https://img.shields.io/badge/Apache-2.0-4green.svg" alt="Apache 2.0">
  <img onerror="this.style.display='none'" src="https://img.shields.io/badge/Release-1.0.7-green.svg" alt="Release">`},{name:"x-easypdf",website:"http://www.x-easypdf.cn/",description:e.X_EASYPDF_DESC,sponsor:"xsx（xsxgit）",date:"2022.07",link:`
...
<a target="_blank" href="https%3A%2F%2Fwork.weixin.qq.com%2Fkfid%2Fkfc9d9d759f27f087e1">
  ...
  <a href="https://gitee.com/dromara/zyplayer-doc/members"><img onerror="this.style.display='none'" src="https://gitee.com/dromara/zyplayer-doc/badge/fork.svg"></a>
    ...
    </a>`},{name:"DyJava",website:"https://gitee.com/dromara/dy-java",description:e.DYJAVA,sponsor:"danmo（sxwdmjy）",date:"2024.04",link:`<a href="https://gitee.com/dromara/dy-java">
      <img onerror="this.style.display='none'" src="https://gitee.com/dromara/dy-java/badge/star.svg" alt="Gitee Stars">
  </a>`},{name:"warm-flow",website:"http://warm-flow.cn",description:e.WARM_FLOW,sponsor:"晓华（min290）",date:"2023.12",link:`<a href="https://gitee.com/dromara/warm-flow">
      <img onerror="this.style.display='none'" src="https://gitee.com/dromara/warm-flow/badge/star.svg" alt="Gitee Stars">
  </a>`},{name:"dbswitch",website:"https://gitee.com/dromara/dbswitch",description:e.DBSWITCH,sponsor:"inrgihc（inrgihc）",date:"2020.12",link:`<a href="https://gitee.com/dromara/dbswitch">
      <img onerror="this.style.display='none'" src="https://gitee.com/dromara/dbswitch/badge/star.svg" alt="Gitee Stars">
  </a>`},{name:"skyeye-oa",website:"https://gitee.com/dromara/skyeye",description:e.SKYEYE_OA,sponsor:"智能制造云办公（doc_wei01_admin）",date:"2022.08",link:`<a href="https://gitee.com/dromara/skyeye">
      <img onerror="this.style.display='none'" src="https://gitee.com/dromara/skyeye/badge/star.svg" alt="Gitee Stars">
  </a>`},{name:"easyAi",website:"https://gitee.com/dromara/easyAi",description:e.EASYAI,sponsor:"唯一解（ldp_dpsmax）",date:"2024.05",link:`<a href="https://gitee.com/dromara/easyAi">
      <img onerror="this.style.display='none'" src="https://gitee.com/dromara/easyAi/badge/star.svg" alt="Gitee Stars">
  </a>`},{name:"mybatis-plus-ext",website:"https://gitee.com/dromara/mybatis-plus-ext",description:e.MYBATIS_PLUS_EXT,sponsor:"唐振超（tangzc）",date:"2021.08",link:`<a href="https://gitee.com/dromara/mybatis-plus-ext">
      <img onerror="this.style.display='none'" src="https://gitee.com/dromara/mybatis-plus-ext/badge/star.svg" alt="Gitee Stars">
      </a>`},{name:"easy-query",website:"https://gitee.com/dromara/easy-query",description:e.EASY_QUERY,sponsor:"薛家明（xuejm）",date:"2023.07",link:`<a href="https://gitee.com/dromara/easy-query">
    ...
    <a target="_blank" href="https://www.oracle.com/java/technologies/javase/jdk17-archive-downloads.html"><img onerror="this.style.display='none'" src="https://img.shields.io/badge/JDK-17-green.svg" alt="jdk-17" /></a>`},{name:"tianai-captcha",website:"https://gitee.com/dromara/tianai-captcha",description:e.TIANAI_CAPTCHA,sponsor:"天爱有情（tianai）",date:"2022.01",link:`<a href="https://gitee.com/dromara/tianai-captcha">
      <img onerror="this.style.display='none'" src="https://gitee.com/dromara/tianai-captcha/badge/star.svg" alt="Gitee Stars">
      </a>
      `},{name:"dax-pay",website:"https://gitee.com/dromara/dax-pay",description:e.DAX_PAY,sponsor:"喵呀（GIotEE）",date:"2023.07",link:`
 ...
 <img onerror="this.style.display='none'" src="https://img.shields.io/badge/license-Apache%20License%202.0-green.svg"/>
      `},{name:"mayfly-go",website:"https://gitee.com/dromara/mayfly-go",description:e.MYFLY_GO,sponsor:"Coder慌（objs）",date:"2022.05",link:`<a href="https://gitee.com/dromara/mayfly-go" target="_blank">
  ...
  <a href="https://cn.vuejs.org" target="_blank">
    <img onerror="this.style.display='none'" src="https://img.shields.io/badge/Vue-3.x-green.svg" alt="vue">
      ...
      `},{name:"MilvusPlus",website:"https://milvus.cn/",description:e.MILVUSPLUS,sponsor:"xgc（giteeClass）",date:"2024.05",link:`<a href="https://gitee.com/dromara/MilvusPlus">
      <img onerror="this.style.display='none'" src="https://gitee.com/dromara/MilvusPlus/badge/star.svg" alt="Gitee Stars">
      </a>
      `},{name:"newcar",website:"https://gitee.com/dromara/newcar",description:e.NEWCAR,sponsor:"Acbox（drwave）",date:"2023.02",link:`  <img onerror="this.style.display='none'" src="https://img.shields.io/github/stars/dromara/newcar?color=yellowgreen&logo=github&style=flat-square" />
  ...
  <a href="https://www.npmjs.com/package/newcar"><img onerror="this.style.display='none'" src="https://img.shields.io/npm/v/newcar.svg"/></a>
      `},{name:"ujcms",website:"https://gitee.com/dromara/ujcms",description:e.UJCMS,sponsor:"ujcms（ujcms）",date:"2024.04",link:`<a href="https://gitee.com/dromara/ujcms">
      <img onerror="this.style.display='none'" src="https://gitee.com/dromara/ujcms/badge/star.svg" alt="Gitee Stars">
      </a>
      `},{name:"carbon",website:"https://gitee.com/dromara/carbon",description:e.CARBON_DESC,sponsor:"勾国印（gouguoyin）",date:"2024.10",link:`
...
<a target="_blank" href="https://github.com/dromara/carbon/blob/master/LICENSE">
...
</a>`}]},{name:e.OPERATIONS_AND_MAINTENANCE_CONTROL,projects:[{name:"TestHub",website:"http://nsrule.com/",description:e.TESTHUB_DESC,sponsor:"失败女神（failedgoddes）",date:"2023.08",link:`
  ...
  `},{name:"domain-admin",website:"https://domain-admin.cn/",description:e.DOMAIN_ADMIN_DESC,sponsor:"mouday",date:"2024.08",link:`
  <img onerror="this.style.display='none'" src="https://img.shields.io/github/stars/dromara/domain-admin.svg?logo=GitHub" alt="">
  `}]},{name:e.BIG_DATA,projects:[{name:"CloudEon",website:"http://www.cloudeon.top/",description:e.CLOUDEON_DESC,sponsor:"Pandas886",date:"2023.04",link:`<a href="https%3A%2F%2Fgithub.com%2Fdromara%2FCloudEon"><img onerror="this.style.display='none'" src="https://views.whatilearened.today/views/github/dromara/CloudEon.svg" alt="HitCount"></a>
  ...
  <img onerror="this.style.display='none'" src="https://img.shields.io/github/v/release/zhugezifang/dataCompare?label=latest&amp;style=flat-square" alt="">`}]},{name:e.MICROSERVICE,projects:[{name:"lamp-cloud",website:"https://tangyh.top/",description:e.LAMP_CLOUD_DESC,sponsor:"最后（zuihou111）",date:"2022.11",link:`
  ...
  <a href=""><img onerror="this.style.display='none'" src="https://img.shields.io/badge/JDK-11-green.svg" alt="JDK-11"></a>`},{name:"J2EEFAST",website:"http://www.j2eefast.com/",description:e.J2EEFAST_DESC,sponsor:"周周（zhouhuanOGP）",date:"2023.03",link:`
  ...
  `}]},{name:e.DISTRIBUTED_SCHEDULING,projects:[{name:"hodor",website:"https://dromara.org/zh/projects/hodor/overview",description:e.HODOR_DESC,sponsor:"tincopper（tomgs）",date:"2023.04",link:`
...
`}]}],M={class:"group-name"},G={class:"project-header"},B=["src","alt"],P={class:"project-name"},Y=["innerHTML"],J={style:{width:"24px"}},z={style:{width:"24px"}},U={__name:"ProjectList",setup(F){const y=k([]);C(()=>{y.value=d(T)});function d(b){function o(n){for(let l=n.length-1;l>0;l--){const i=Math.floor(Math.random()*(l+1));[n[l],n[i]]=[n[i],n[l]]}}return o(b),b.forEach(n=>o(n.projects)),b}return(b,o)=>{const n=D("n-icon");return h(),m("div",null,[(h(!0),m(u,null,v(y.value,l=>(h(),m(u,{key:l.name},[t(a(_),{"title-placement":"left"},{default:s(()=>[r("span",M,p(l.name),1)]),_:2},1024),t(a(N),{style:{"margin-top":"16px"},"x-gap":16,"y-gap":16,cols:"2 s:1"},{default:s(()=>[(h(!0),m(u,null,v(l.projects,i=>(h(),j(a(L),{key:i.name},{default:s(()=>[t(a(I),{hoverable:"",class:"project-card"},{cover:s(()=>[r("div",G,[r("img",{src:`/project/logo/${i.name}.webp`,alt:i.name,class:"project-logo",onerror:"this.style.display = 'none';this.nextElementSibling.style.display = 'block'"},null,8,B),r("span",P,p(i.name),1)])]),default:s(()=>[t(a(f),{vertical:""},{default:s(()=>[t(a(c),{depth:"2"},{default:s(()=>[g(p(i.description),1)]),_:2},1024),t(a(f),{vertical:""},{default:s(()=>[t(a(c),{depth:"2"},{default:s(()=>[t(a(c),{strong:"",depth:"2"},{default:s(()=>o[0]||(o[0]=[g("作者：")])),_:1}),g(" "+p(i.sponsor),1)]),_:2},1024),t(a(c),{depth:"2"},{default:s(()=>[t(a(c),{strong:"",depth:"2"},{default:s(()=>o[1]||(o[1]=[g("加入时间：")])),_:1}),g(" "+p(i.date),1)]),_:2},1024),r("p",{class:"project-link",innerHTML:i.link},null,8,Y),t(a(_)),t(a(f),null,{default:s(()=>[r("div",J,[t(a(E),{trigger:"hover"},{trigger:s(()=>[t(a(w),{href:`https://github.com/dromara/myth${i.name}`,target:"_blank"},{default:s(()=>[t(n,null,{default:s(()=>[t(a(x))]),_:1})]),_:2},1032,["href"])]),default:s(()=>[o[2]||(o[2]=g(" 访问 GitHub 仓库 "))]),_:2},1024)]),r("div",z,[t(a(E),{trigger:"hover"},{trigger:s(()=>[t(a(w),{href:`https://gitee.com/dromara/${i.name}`,target:"_blank"},{default:s(()=>[t(n,null,{default:s(()=>o[3]||(o[3]=[r("svg",{xmlns:"http://www.w3.org/2000/svg",id:"Group",viewBox:"0 0 89.7088726 89.7088726"},[r("g",null,[r("circle",{id:"Combined-Shape",fill:"#C71D23",cx:"44.8544363",cy:"44.8544363",r:"44.8544363"}),r("path",{d:"M67.558546,39.8714292 L42.0857966,39.8714292 C40.8627004,39.8720094 39.8710953,40.8633548 39.8701949,42.0864508 L39.8687448,47.623783 C39.867826,48.8471055 40.8592652,49.8390642 42.0825879,49.8393845 C42.0827874,49.8393846 42.0829869,49.8393846 42.0831864,49.8387862 L57.5909484,49.838657 C58.8142711,49.8386283 59.8059783,50.830319 59.8059885,52.0536417 C59.8059885,52.0536479 59.8059885,52.053654 59.8059701,52.0536602 L59.8059701,52.6073539 L59.8059701,52.6073539 L59.8059701,53.161115 C59.8059701,56.8310831 56.8308731,59.80618 53.160905,59.80618 L32.1165505,59.80618 C30.8934034,59.806119 29.9018373,58.8145802 29.9017425,57.5914331 L29.9011625,36.5491188 C29.9008781,32.8791508 32.8758931,29.9039718 36.5458611,29.9038706 C36.5459222,29.9038706 36.5459833,29.9038706 36.5460443,29.9040538 L67.5523638,29.9040538 C68.77515,29.9026795 69.7666266,28.9118177 69.7687593,27.6890325 L69.7721938,22.1516997 C69.774326,20.928378 68.7832423,19.9360642 67.5599198,19.9353054 C67.5594619,19.9353051 67.5590039,19.935305 67.558546,19.9366784 L36.5479677,19.9366784 C27.3730474,19.9366784 19.935305,27.3744208 19.935305,36.549341 L19.935305,67.558546 C19.935305,68.7818687 20.927004,69.7735676 22.1503267,69.7735676 L54.8224984,69.7735676 C63.079746,69.7735676 69.7735676,63.079746 69.7735676,54.8224984 L69.7735676,42.0864509 C69.7735676,40.8631282 68.7818687,39.8714292 67.558546,39.8714292 Z",id:"G",fill:"#FFFFFF"})])],-1)])),_:1})]),_:2},1032,["href"])]),default:s(()=>[o[4]||(o[4]=g(" 访问 Gitee 仓库 "))]),_:2},1024)])]),_:2},1024)]),_:2},1024)]),_:2},1024)]),_:2},1024)]),_:2},1024))),128))]),_:2},1024)],64))),128))])}}},H=A(U,[["__scopeId","data-v-873dd12a"]]),K=JSON.parse('{"title":"孵化中的项目","description":"","frontmatter":{"layout":"home","footer":true,"title":"孵化中的项目"},"headers":[],"relativePath":"projects.md","filePath":"projects.md"}'),V={name:"projects.md"},X=Object.assign(V,{setup(F){return(y,d)=>(h(),m("div",null,[d[0]||(d[0]=r("h1",{id:"dromara-开源社区-孵化中的项目",tabindex:"-1"},[g("Dromara 开源社区 :: 孵化中的项目 "),r("a",{class:"header-anchor",href:"#dromara-开源社区-孵化中的项目","aria-label":'Permalink to "Dromara 开源社区 :: 孵化中的项目"'},"​")],-1)),t(H)]))}});export{K as __pageData,X as default};
