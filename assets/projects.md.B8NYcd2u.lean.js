...
<a target="_blank" href="https://github.com/dromara/carbon/blob/master/LICENSE">
...
</a>`},{name:"TestHub",website:"http://nsrule.com/",description:e.TESTHUB_DESC,sponsor:"失败女神（failedgoddes）",date:"2023.08",link:`
  ...
  `},{name:"CloudEon",website:"http://www.cloudeon.top/",description:e.CLOUDEON_DESC,sponsor:"Pandas886",date:"2023.04",link:`<a href="https%3A%2F%2Fgithub.com%2Fdromara%2FCloudEon"><img onerror="this.style.display='none'" src="https://views.whatilearened.today/views/github/dromara/CloudEon.svg" alt="HitCount"></a>
  ...
  <img onerror="this.style.display='none'" src="https://img.shields.io/github/v/release/zhugezifang/dataCompare?label=latest&amp;style=flat-square" alt="">`},{name:"lamp-cloud",website:"https://tangyh.top/",description:e.LAMP_CLOUD_DESC,sponsor:"最后（zuihou111）",date:"2022.11",link:`
  ...
  `},{name:"hodor",website:"https://dromara.org/zh/projects/hodor/overview",description:e.HODOR_DESC,sponsor:"tincopper（tomgs）",date:"2023.04",link:`
...
`}],R={class:"project-header"},M=["src","alt"],T={class:"project-name"},G=["innerHTML"],B={style:{width:"24px"}},P={style:{width:"24px"}},Y={__name:"ProjectList",setup(y){const m=_([]);return w(()=>{m.value=O.sort((l,o)=>l.name.localeCompare(o.name))}),(l,o)=>{const b=S("n-icon");return h(),u(a(j),{style:{"margin-top":"16px"},"x-gap":16,"y-gap":16,cols:"2 s:1"},{default:s(()=>[(h(!0),c(k,null,A(m.value,i=>(h(),u(a(C),{key:i.name},{default:s(()=>[t(a(L),{hoverable:"",class:"project-card"},{cover:s(()=>[r("div",R,[r("img",{src:`/project/logo/${i.name}.webp`,alt:i.name,class:"project-logo",onerror:"this.style.display = 'none';this.nextElementSibling.style.display = 'block'"},null,8,M),r("span",T,d(i.name),1)])]),default:s(()=>[t(a(p),{vertical:""},{default:s(()=>[t(a(g),{depth:"2"},{default:s(()=>[n(d(i.description),1)]),_:2},1024),t(a(p),{vertical:""},{default:s(()=>[t(a(g),{depth:"2"},{default:s(()=>[t(a(g),{strong:"",depth:"2"},{default:s(()=>o[0]||(o[0]=[n("作者：")])),_:1}),n(" "+d(i.sponsor),1)]),_:2},1024),t(a(g),{depth:"2"},{default:s(()=>[t(a(g),{strong:"",depth:"2"},{default:s(()=>o[1]||(o[1]=[n("加入时间：")])),_:1}),n(" "+d(i.date),1)]),_:2},1024),r("p",{class:"project-link",innerHTML:i.link},null,8,G),t(a(D)),t(a(p),null,{default:s(()=>[r("div",B,[t(a(f),{trigger:"hover"},{trigger:s(()=>[t(a(F),{href:`https://github.com/dromara/myth${i.name}`,target:"_blank"},{default:s(()=>[t(b,null,{default:s(()=>[t(a(x))]),_:1})]),_:2},1032,["href"])]),default:s(()=>[o[2]||(o[2]=n(" 访问 GitHub 仓库 "))]),_:2},1024)]),r("div",P,[t(a(f),{trigger:"hover"},{trigger:s(()=>[t(a(F),{href:`https://gitee.com/dromara/${i.name}`,target:"_blank"},{default:s(()=>[t(b,null,{default:s(()=>o[3]||(o[3]=[r("svg",{xmlns:"http://www.w3.org/2000/svg",id:"Group",viewBox:"0 0 89.7088726 89.7088726"},[r("g",null,[r("circle",{id:"Combined-Shape",fill:"#C71D23",cx:"44.8544363",cy:"44.8544363",r:"44.8544363"}),r("path",{d:"M67.558546,39.8714292 L42.0857966,39.8714292 C40.8627004,39.8720094 39.8710953,40.8633548 39.8701949,42.0864508 L39.8687448,47.623783 C39.867826,48.8471055 40.8592652,49.8390642 42.0825879,49.8393845 C42.0827874,49.8393846 42.0829869,49.8393846 42.0831864,49.8387862 L57.5909484,49.838657 C58.8142711,49.8386283 59.8059783,50.830319 59.8059885,52.0536417 C59.8059885,52.0536479 59.8059885,52.053654 59.8059701,52.0536602 L59.8059701,52.6073539 L59.8059701,52.6073539 L59.8059701,53.161115 C59.8059701,56.8310831 56.8308731,59.80618 53.160905,59.80618 L32.1165505,59.80618 C30.8934034,59.806119 29.9018373,58.8145802 29.9017425,57.5914331 L29.9011625,36.5491188 C29.9008781,32.8791508 32.8758931,29.9039718 36.5458611,29.9038706 C36.5459222,29.9038706 36.5459833,29.9038706 36.5460443,29.9040538 L67.5523638,29.9040538 C68.77515,29.9026795 69.7666266,28.9118177 69.7687593,27.6890325 L69.7721938,22.1516997 C69.774326,20.928378 68.7832423,19.9360642 67.5599198,19.9353054 C67.5594619,19.9353051 67.5590039,19.935305 67.558546,19.9366784 L36.5479677,19.9366784 C27.3730474,19.9366784 19.935305,27.3744208 19.935305,36.549341 L19.935305,67.558546 C19.935305,68.7818687 20.927004,69.7735676 22.1503267,69.7735676 L54.8224984,69.7735676 C63.079746,69.7735676 69.7735676,63.079746 69.7735676,54.8224984 L69.7735676,42.0864509 C69.7735676,40.8631282 68.7818687,39.8714292 67.558546,39.8714292 Z",id:"G",fill:"#FFFFFF"})])],-1)])),_:1})]),_:2},1032,["href"])]),default:s(()=>[o[4]||(o[4]=n(" 访问 Gitee 仓库 "))]),_:2},1024)])]),_:2},1024)]),_:2},1024)]),_:2},1024)]),_:2},1024)]),_:2},1024))),128))]),_:1})}}},J=E(Y,[["__scopeId","data-v-9f11e88e"]]),V=JSON.parse('{"title":"孵化项目","description":"","frontmatter":{"layout":"home","footer":true,"title":"孵化项目"},"headers":[],"relativePath":"projects.md","filePath":"projects.md"}'),z={name:"projects.md"},Q=Object.assign(z,{setup(y){return(m,l)=>(h(),c("div",null,[l[0]||(l[0]=r("h1",{id:"孵化项目",tabindex:"-1"},[n("孵化项目 "),r("a",{class:"header-anchor",href:"#孵化项目","aria-label":'Permalink to "孵化项目"'},"​")],-1)),t(J)]))}});export{V as __pageData,Q as default};
